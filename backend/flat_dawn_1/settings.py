"""
Django settings for flat_dawn_1 project.
...
WSGI_APPLICATION = 'flat_dawn_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_dawn_1 API",
    "DESCRIPTION": "API documentation for flat_dawn_1 App",
    "VERSION": "v1",
}
